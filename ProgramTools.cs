...
namespace TransactionDemoConsole
{
    partial class Program
    {
        ...
        private static async Task CreateCollection(DocumentClient client)
        {
            ...
            await CreateStoredProce(client, _collection.SelfLink);
        }

        private static async Task CreateStoredProce(DocumentClient client, string collectionLink)
        {
            string scriptFileName = @"JS\BuyItems.js";
            ...
            Console.WriteLine("Stored Procedure '{0}' has been created",sproc.Id);
